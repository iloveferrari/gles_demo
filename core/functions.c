...
following function, based on GetScattering (we duplicate some code here, instead of 
using two calls to GetScattering, to make sure that the texture coordinates 
computation is shared between the lookups in scattering_texture and
